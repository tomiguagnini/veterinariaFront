...
const Register = () => {
  ...
  const PostData = async () => {
    const response = await serviceUser.register(
      name.value,
      lastname.value,
      password.value,
      email.value,
          ...
          <form onSubmit={verificarCampos}>
            <div className="shadow bg-slate-300 overflow-hidden rounded ">
              <div className="p-6 sm:p-12 md:w-full">
                {data ? (
                  <label className="mb-2 text-white text-sm text-center bg-red-600 p-2 rounded-md block ">
                    {data.msg}
                  </label>
                ) : (
                  ""
                ...
                <div className="">
                  ...
                  <Input
                    ...
                    msgErr={email.validate ? "" : email.err}
                  />
                  ...
                  <Input
                    ...
                    msgErr={password.validate ? "" : password.err}
                  />
